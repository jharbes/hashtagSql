...
-- Essa tabela deve conter 4 colunas: id_produt, nome_produto, data_validade e preco_produto
...
SELECT
	ProductKey,
	ProductName,
	AvailableForSaleDate, -- coluna escolhida aleatoriamente pois nao possui o mesmo significado de data_validade
	UnitPrice
FROM
